...
INSERT INTO `customer_addresses` (`address_id`, `address_line1`, `address_line2`, `city`, `postal_code`, `customer_id`) VALUES
(5, 'No. 71/3, Putupagala, Mandawala', NULL, 'Default City', '00000', 3),
(6, 'n', NULL, 'Default City', '00000', 3),
(7, 's', NULL, 'Default City', '00000', 3),
(8, 'test', NULL, 'Default City', '00000', 3);
...
(1, '0', '<< Flyway Baseline >>', 'BASELINE', '<< Flyway Baseline >>', NULL, 'root', '2025-09-26 05:25:18', 0, 1),
(2, '1', 'align unsigned bigint', 'SQL', 'V1__align_unsigned_bigint.sql', 1060960412, 'root', '2025-09-26 05:31:32', 5219, 0);
...
INSERT INTO `users` (`user_id`, `username`, `password_hash`, `email`, `full_name`, `phone`, `role`, `address`, `created_at`, `is_active`) VALUES
(1, 'Vihanga', '$2a$10$YGwqfAQOglLB1AfLCeGzsuUKtfxyGoR3KT27jaZ/mrWeCohRST3x2', 'vdeshan044@gmail.com', 'Vihanga Deshan Sammandapperuma', '0767228640', 'admin', 'No. 71/3, Putupagala, Mandawala', '2025-09-25 01:47:48', 1),
(3, 'Akaa', '$2a$10$dsU1ss2/deTwF4sNbsZQ1.1qWdog7cb5xm8Mshxp6pRReHLknsqeO', 'akini@gmail.com', 'Akini Panapitiya', '0703450059', 'customer', '', '2025-09-25 10:06:30', 1);
